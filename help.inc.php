...
?>
   ...
   <p>
      a href="<?php echo $REX["FRONTEND_FILE"]; ?>?rex_img_type=formstone_resize_{$rex_img_size_window}&rex_img_file={$rex_img}" rel="group-REX_ARTICLE_ID-REX_SLICE_ID" class="formstoneStyle{$rex_img_js_style}"<br />
         &nbsp;&nbsp;&nbsp;&nbsp;img src="<?php echo $REX["FRONTEND_FILE"]; ?>?rex_img_type=formstone_resize_{$rex_img_size}&rex_img_file={$rex_img}" title="{$rex_img_txt}" alt="{$rex_img}"<br />
      /a
   </p>